...
App.log('App.start_program("UploadTiles.bat")')
App.start_program("UploadTiles.bat")
...
App.log('App.start_program("UploadTiles.bat", "TileUpdate16.zip"])')
App.start_program("UploadTiles.bat", ["TileUpdate16.zip"])
